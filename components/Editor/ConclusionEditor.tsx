    ...
    <div className="p-8 max-w-4xl mx-auto space-y-10 pb-20">
      ...
      <header className="flex justify-between items-end border-b border-border pb-6">
        <div>
          ...
          <h2 className="text-4xl mystery-font font-bold text-foreground mt-1">{t.conclusionSettings}</h2>
          <p className="text-muted-foreground text-xs mt-2">{t.conclusionHint}</p>
        </div>
        <button
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Success Config */}
          <div className="bg-emerald-900/5 p-6 rounded-2xl border border-emerald-500/20 space-y-4 shadow-sm">
